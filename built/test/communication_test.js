...
describe('communicaion API, consistency of transferred data', () => {
    ...
    it('destination .send() should return a unit or undefined if such is not available', () => {
        ...
        assert(typeof peerB.destination('UNREGISTERED_ROLE').send('someMSG', 1) === 'undefined');
    });
    it('if requested role is not registered peer should automatically respond with an error', () => __awaiter(void 0, void 0, void 0, function* () {
        [peerA1, peerA2, peerA3, peerA4, peerA5].forEach(peer => {
    ...
    it('if request handler for an event is not provided peer should automatically respond with an error', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('.send should send data to only one connected unit', () => __awaiter(void 0, void 0, void 0, function* () {
        let i = 0;
        [peerA1, peerA2, peerA3, peerA4, peerA5].forEach(peer => {
    ...
    it('middleware should apply from more common to more specific direction', (done) => {
        ...
        peerB.onData((ctx) => __awaiter(void 0, void 0, void 0, function* () {
            ctx.response = '1';
            yield ctx.next();
            ctx.response += '1';
        }));
        peerB.onRequest((ctx, cb) => __awaiter(void 0, void 0, void 0, function* () {
            ctx.response += '2';
            ctx.next().then(() => {
                ctx.response += '2';
            });
        }));
        peerB.role('B').onData((ctx) => __awaiter(void 0, void 0, void 0, function* () {
            ctx.response += '3';
            yield ctx.next();
            ctx.response += '3';
        }));
        peerB.role('B').onRequest((ctx, cb) => __awaiter(void 0, void 0, void 0, function* () {
            ctx.response += '4';
            yield ctx.next();
            ctx.response += '4';
        }));
